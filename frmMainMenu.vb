Public Class frmMainMenu
    ...
    Private Sub MicrosoftWordToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MicrosoftWordToolStripMenuItem.Click
        Try
            System.Diagnostics.Process.Start("MS Word.exe")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
